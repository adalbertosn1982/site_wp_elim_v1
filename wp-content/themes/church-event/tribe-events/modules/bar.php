			...
			<div class="tribe-bar-filters">
				<div class="tribe-bar-filters-inner tribe-clearfix">
					...
					<div class="tribe-bar-submit">
						<button class="tribe-no-param button button-border accent1 hover-accent1" type="submit" name="submit-bar"><span class="icon"><?php wpv_icon('search1') ?></span><span class="btext"><?php printf( __( 'Find %s', 'tribe-events-calendar' ), tribe_get_event_label_plural() ); ?></span></button>
